...
def sort_by_heat(spicy_foods)
  # your code here
  spicy_foods.sort { |food, food1| food[:heat_level] - food1[:heat_level] }
end
...
def print_spiciest_foods(spicy_foods)
  ...
  .each {| food | puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * food[:heat_level]}"}
end
...
def average_heat_level(spicy_foods)
  # your code here
  spicy_foods.collect { |food| food[:heat_level] } .sum / spicy_foods.length
end
